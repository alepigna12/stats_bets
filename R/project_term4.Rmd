...
Use Kelly's strategy (strategy = "optimal"), with no betting restrictions.
Empirically, the mean return of betting with one dollar is
     25%      50%      75% (single prob, mean: 1.028571, final: 4.457478e+14)
1.001835 1.005950 1.016063 

6.371263e+12
      25%       50%       75% 
0.9913701 1.0033943 1.0235912 
[1] 1.026983 - mean (median_prob)

[1] 2.920471e+14
      25%       50%       75% 
0.9946558 1.0043205 1.0207849 
[1] 1.030855 - mean (mean_prob)
...
[1] 4.457478e+14
     25%      50%      75% 
1.001835 1.005950 1.016063 
[1] 1.028571 - single prob

[1] 2.45111e+19
     25%      50%      75% 
1.002135 1.006602 1.016746 
[1] 1.049047 - mean prob

[1] 5.512082e+20
     25%      50%      75% 
1.002260 1.006627 1.016703 
[1] 1.057374 - median prob

The above shows that single prob is the most accurate one in estimating the implied probability because it has the least difference between the expectation and the empirical results.
...
Now, add betting restrictions and use only the optimal strategy.

[1] 976194
      25%       50%       75% 
0.9942854 1.0016535 1.0107414 
[1] 1.009968 - single prob

[1] 957753.8
      25%       50%       75% 
0.9913198 0.9991383 1.0109548 
[1] 1.012265 - mean prob

[1] 958503.1
      25%       50%       75% 
0.9913092 0.9991376 1.0121025 
[1] 1.010224 - median prob

Expected results

[1] 650768.2
     25%      50%      75% 
1.000196 1.000793 1.004741 
[1] 1.008466 - single prob

[1] 1559826
     25%      50%      75% 
1.000183 1.000721 1.005719 
[1] 1.009326 - mean prob

[1] 1617053
     25%      50%      75% 
1.000189 1.000734 1.005797 
[1] 1.0093 - median prob
...
For optimal strategy, try with different method to estimate the implied probability: method = "single_prob", "median_prob", "mean_prob".

Start with 1 dollar. No restrictions on the amount used to bet.

[1] 1
25% 50% 75% 
  1   1   1 
[1] 1 - single prob (didn't bet at all)

[1] 0.2785226
      25%       50%       75% 
0.9967646 1.0000000 1.0000000 
[1] 0.9999781 - mean prob

[1] 0.1754585
      25%       50%       75% 
0.9964413 1.0000000 1.0000000 
[1] 0.9999472 - median prob
...
[1] 9.380456
     25%      50%      75% 
1.000000 1.000000 1.000076 
[1] 1.000166 - mean prob

[1] 10.4179
    25%     50%     75% 
1.00000 1.00000 1.00008 
[1] 1.000174 - median prob
...
Arbitrages are removed.

Compare with random betting (bet 0.5 on one team and 0.5 on the other)
Bet only on the favorite (hold 0.5 money, bet 0.5 on the more favorable team)
Bet only on the less favorite (hold 0.9 money, bet 0.1 on the less favorable team)
Compare the empirical results with expected return (implied prob * odds) for all strategies above

Strategy: unit: 5 cents; Amount to bet: [1, 10,000]
 - conservative strategy: round down on the amount to bet; Don't bet if the total amount is fewer than 1 dollar. Start with 10 dollars.

Different ways to aggregate across bookies to get the implied probability

Bet on games with more than two choices
...
[1] 4.563418e+15
     25%      50%      75% 
1.005085 1.012048 1.025493 
[1] 1.027012 - single prob


[1] 3.046808e+12
      25%       50%       75% 
0.9794298 1.0063309 1.0465954 
[1] 1.022213 - mean prob
...
[1] 513572.7
      25%       50%       75% 
0.9967008 0.9967008 0.9967008 
[1] 0.9967008 - single prob

[1] 361490.9
      25%       50%       75% 
0.9953193 0.9953193 0.9953193 
[1] 0.9953193 - mean prob
